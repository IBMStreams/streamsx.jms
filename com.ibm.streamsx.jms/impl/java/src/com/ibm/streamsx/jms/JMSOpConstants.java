...
public class JMSOpConstants {
	...
	public static final String PARAM_JMS_HEADER_EXPIRATION_O_ATTR_NAME		= "jmsExpirationOutAttrName";		//$NON-NLS-1$
	public static final String PARAM_JMS_HEADER_PRIORITY_O_ATTR_NAME		= "jmsPriorityOutAttrName";			//$NON-NLS-1$
	public static final String PARAM_JMS_HEADER_MESSAGEID_O_ATTR_NAME		= "jmsMessageIDOutAttrName";		//$NON-NLS-1$
	public static final String PARAM_JMS_HEADER_TIMESTAMP_O_ATTR_NAME		= "jmsTimestampOutAttrName";		//$NON-NLS-1$
	public static final String PARAM_JMS_HEADER_CORRELATIONID_O_ATTR_NAME	= "jmsCorrelationIDOutAttrName";	//$NON-NLS-1$
	public static final String PARAM_JMS_HEADER_REPLYTO_O_ATTR_NAME			= "jmsReplyToOutAttrName";			//$NON-NLS-1$
	public static final String PARAM_JMS_HEADER_TYPE_O_ATTR_NAME			= "jmsTypeOutAttrName";				//$NON-NLS-1$
